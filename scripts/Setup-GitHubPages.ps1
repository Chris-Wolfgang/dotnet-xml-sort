...
param(
    [Parameter()]
    [string]$Repository = "Chris-Wolfgang/dotnet-xml-sort",
...
if ($Repository -eq "Chris-Wolfgang/dotnet-xml-sort" -or -not $Repository) {
    ...
    try {
        ...
        if ($Repository -eq "Chris-Wolfgang/dotnet-xml-sort") {
